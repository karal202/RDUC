          ...
          <div class="activation-screen">
            ...
            <aside class="activation-art">
              ...
              <div class="activation-art-copy">
                ...
                <h1>Re-activate your rig</h1>
                <p>Key của bạn đã bị thu hồi. Nhập key mới được cấp để tiếp tục truy cập.</p>
              </div>
            </aside>
            ...
            <section class="activation-panel">
              ...
              <p class="activation-lead">
                Khóa key cũ đã hết hiệu lực. Nhập key mới được hỗ trợ cấp để mở khóa lại.
              </p>
              ...
              <form class="activation-form" @submit.prevent="handleActivate">
                <div class="key-field-heading">
                  <label class="field-label" for="license-key-modal">Mã key kích hoạt</label>
